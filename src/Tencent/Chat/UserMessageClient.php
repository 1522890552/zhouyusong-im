...
namespace im\Tencent\Chat;

use GuzzleHttp\Exception\GuzzleException;
use im\Kernel\Interfaces\UserMessageInterface;
use im\Kernel\Support\Timer;
...
class UserMessageClient extends TencentClient implements UserMessageInterface
{
     ...
     * @return mixed
     */
    public function sendMessage($userId, array $messageBody, $fromUserId = '', $syncOtherMachine = \im\Tencent\User\UserMessageClient::SYNC_OTHER_MACHINE_NO, $msgLifeTime = 604800)
    {
        $params = [
